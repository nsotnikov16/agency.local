        ...
        <div class="footer__wrapper">
            ...
            <div class="footer__menu-wrapper">
                ...
                <nav class="footer__nav">
                    ...
                    <a href="<?=getCityURL()?>" class="footer__nav-link">CRM</a>
                    <a href="<?=getCityURL()?>" class="footer__nav-link">CMS</a>
                    <a href="<?=getCityURL()?>" class="footer__nav-link">Хостинг и домен</a>
                    <a href="<?=getCityURL()?>" class="footer__nav-link">Виртуальный сервер</a>
                    <a href="<?=getCityURL()?>" class="footer__nav-link">Пример оформления ТЗ</a>
                </nav>
            </div>
        </div>
